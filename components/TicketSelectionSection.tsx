  ...
  return (
    <section className="w-full">
      <header className="w-full">
        ...
        <nav className="flex justify-center items-start w-full">
          <div className="flex flex-1 justify-center items-center bg-white px-0 pt-6 pb-3.5 border-t-[10px] border-t-solid min-h-11">
            <div className="inline-flex flex-col items-center">
              <div className="mt-[-1.00px] w-fit font-bold text-[14.9px] text-black text-center leading-4 tracking-[0] whitespace-nowrap [font-family:'Inter',Helvetica]">
                Bus Tours
              </div>
            </div>
          </div>

          <div className="flex flex-1 justify-center items-start px-0 pt-2.5 pb-0">
            <div className="flex flex-1 justify-center items-center bg-[#550a1d] px-0 py-3.5 min-h-11">
              <div className="inline-flex flex-col items-center">
                <div className="mt-[-1.00px] w-fit font-bold text-[14.5px] text-white text-center leading-4 tracking-[0] whitespace-nowrap [font-family:'Inter',Helvetica]">
                  Combination Tickets
                </div>
              </div>
            </div>
      ...
      <main className="w-full">
        <div className="flex flex-col items-center px-0 pt-[29px] pb-5 w-full">
          <div className="flex flex-col items-start w-full max-w-[960px]">
            <div className="flex items-center w-full">
              <div className="inline-flex flex-col items-start px-0 pt-0 pb-[0.59px]">
                <h2 className="mt-[-1.00px] w-fit font-bold text-[#444444] text-[32.5px] leading-[39.6px] tracking-[0] whitespace-nowrap [font-family:'Inter',Helvetica]">
                  Choose a ticket
                </h2>
              </div>
            </div>
